...
import { View, ImageBackground, Image, Text, StyleSheet, Picker, Alert } from 'react-native';
    ...
    <ImageBackground style={styles.container} source={require('../../assets/home-background.png')} imageStyle={{ width: 274, height: 368 }} >
      ...
      <View style={styles.footer} >
        <Picker
          ...
          onValueChange={(itemValue, itemIndex) => setSelectedUf(String(itemValue))}
          mode='dialog'
        >
        ...
        <Picker
          ...
          onValueChange={(itemValue, itemIndex) => setSelectedCity(String(itemValue))}
          mode='dialog'
        >
